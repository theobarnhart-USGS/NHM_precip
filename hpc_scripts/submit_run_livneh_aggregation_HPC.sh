...
#SBATCH --time=50:00:00           # Overestimated guess at time, the process will be cancelled at the time limit (this case 6 hours), prod allows 21 day jobs.
...
srun python -u  ~/projects/NHM_precipitation/hpc_scripts/aggregate_livneh2016.py $reg
